      ...
      <Typewriter
        options={{
          strings: [
            ...
            "Hey Brainy, give this photo a boost.",
            "Brainy, enhance the details in this photo.",
            "Activate Brainy mode to refine this photo.",
            "Brainy, apply your magic to this photo.",
          ],
          autoStart: true,
          loop: true,
        }}
